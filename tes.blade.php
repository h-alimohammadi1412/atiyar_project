...
<meta name="keywords"
      content="فروشگاه اینترنتی, خرید آنلاین، موبایل, تبلت, لپ تاپ, تلویزیون, کامپیوتر, دوربین, کتاب,لوازم خانگی, عطر و ادکلن, فروش اینترنتی، آتی یار، آتی یار"/>
{{--<link rel="stylesheet" href="{{asset('/css/8ba74341.css')}}">--}}
<link rel="stylesheet"
