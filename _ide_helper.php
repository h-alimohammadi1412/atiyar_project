...
')
     ...
     */ 
         ...
         * @param string $title
         * @param string $icon
         * @return \Tdanandeh\SweetAlert\SweetAlertNotifier $this
         * @static 
         */ 
        public static function message($text = '', $title = null, $icon = null)
        {
                        /** @var \Tdanandeh\SweetAlert\SweetAlertNotifier $instance */
...
namespace  { 
            ...
            class Alert extends \Tdanandeh\SweetAlert\SweetAlert {}
