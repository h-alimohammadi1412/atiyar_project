...
class CreateCategoryProductSwiperTable extends Migration
{
    /**
     * Run the migrations.
     *
...
//        Schema::connection('mysql-category')->create('category_product_swiper', function (Blueprint $table) {
        Schema::create('category_product_swiper', function (Blueprint $table) {
            $table->id();
...
//        Schema::connection('mysql-category')->dropIfExists('category_product_swiper');
        Schema::dropIfExists('category_product_swiper');
    }
}
