...
class CreateCategoryAmazingTable extends Migration
{
    /**
     * Run the migrations.
     *
...
//        Schema::connection('mysql-category')->create('category_amazing', function (Blueprint $table) {
        Schema::create('category_amazing', function (Blueprint $table) {
            $table->id();
    ...
    {
//        Schema::connection('mysql-category')->dropIfExists('category_amazing');
        Schema::dropIfExists('category_amazing');
    }
}
