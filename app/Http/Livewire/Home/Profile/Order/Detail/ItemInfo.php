...
class ItemInfo extends AdminControllerLivewire
{
   ...
   return redirect(route('order.profile.canceled'));
    ...
    public function render()
    {
        ...
        return view('livewire.home.profile.order.detail.item-info'
        ,compact('order_number','orders','payment_first','payments','returnedPayments'
            ,'order_first'))->layout('layouts.home');
    }
}
