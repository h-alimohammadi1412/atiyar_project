...
<div class="remodal-wrapper remodal-is-closed" style="display: none;">
    <div
        class="remodal c-modal c-u-minicart__modal u-hidden js-ab-minicart-modal remodal-is-initialized remodal-is-closed"
        ...
        <div class="c-u-minicart">
            <div class="c-cart-item" data-price-change="" data-min-price-badge="">
                <div class="c-cart-item__thumb">
                    <a class="c-cart-item__thumb-img" href="" target="_blank">
                        <img
                            alt="کتاب مجموعه آزمونهای مستند و پرتکرار برگزار شده استخدامی اندیشه اسلامی اثر الهه مایلی و فاطمه لقایی انتشارات رویای سبز"
                            src="https://dkstatics-public.digikala.com/digikala-products/92b66983d0e9ca92d36ed06f0266f5b781e1d6a1_1605520534.jpg?x-oss-process=image/resize,m_lfit,h_150,w_150/quality,q_80">
                    </a>
                    <div class="c-cart-item__price-row">
                        <div class="c-cart-item__quantity-row">
                            <div class="c-quantity-selector">
                                ...
                                <div class="c-quantity-selector__number js-minicart-count" data-id="20875996">
                                    ۱
                                </div>
                                <button type="button"
                                ...
                                <button type="button" class="c-quantity-selector__trash js-mini-cart-remove-item "
                                        data-id="1440135345" data-product="3773107" data-variant="20875996"
                ...
                <div class="c-cart-item__data">
                    ...
                    <div class="c-cart-item__title">
                        کتاب مجموعه آزمونهای مستند و پرتکرار برگزار شده استخدامی اندیشه اسلامی اثر الهه مایلی و فاطمه
                        لقایی انتشارات رویای سبز
                    </div>
            ...
            <div class="c-cart-item" data-price-change="" data-min-price-badge="">
                <div class="c-cart-item__thumb">
                    <a class="c-cart-item__thumb-img" href="" target="_blank">
                        <img
                            alt="کتاب نمونه آزمونهای مستند و پرتکرار برگزار شده استخدامی اصول آموزش ریاضی اثر زهرا طهاسبی انتشارات رویای سبز"
                            src="https://dkstatics-public.digikala.com/digikala-products/41a0e62c65a8638f57c87e7db8e4763b49ca123d_1631594784.jpg?x-oss-process=image/resize,m_lfit,h_150,w_150/quality,q_80">
                    </a>
                    <div class="c-cart-item__price-row">
                        <div class="c-cart-item__quantity-row">
                            <div class="c-quantity-selector">
                                ...
                                <div class="c-quantity-selector__number js-minicart-count" data-id="21596132">
                                    ۱
                                </div>
                                <button type="button"
                                        class="c-quantity-selector__remove u-hidden c-quantity-selector__add--disabled js-minicart-remove">
                                ...
                                <button type="button" class="c-quantity-selector__trash js-mini-cart-remove-item "
                                        data-id="1440136710" data-product="6445099" data-variant="21596132"
                                        data-enhanced-ecommerce="null">
                                </button>
                            </div>
                        </div>
                ...
                <div class="c-cart-item__data">
                    ...
                    <div class="c-cart-item__title">
                        کتاب نمونه آزمونهای مستند و پرتکرار برگزار شده استخدامی اصول آموزش ریاضی اثر زهرا طهاسبی
                        انتشارات رویای سبز
                    </div>
            ...
            <div class="c-cart-item" data-price-change="" data-min-price-badge="">
                <div class="c-cart-item__thumb">
                    <a class="c-cart-item__thumb-img" href="" target="_blank">
                        <img
                            alt="کتاب نمونه آزمونهای مستند و پرتکرار برگزار شده استخدامی مبانی جبر اثر فاطمه عزیزی نیک انتشارات&nbsp;رویای سبز"
                            src="https://dkstatics-public.digikala.com/digikala-products/15971ac68c92c8f108b90a89120fbd5a8fa9b32a_1630299558.jpg?x-oss-process=image/resize,m_lfit,h_150,w_150/quality,q_80">
                    </a>
                    <div class="c-cart-item__price-row">
                        <div class="c-cart-item__quantity-row">
                            <div class="c-quantity-selector">
                                ...
                                <div class="c-quantity-selector__number js-minicart-count" data-id="21059414">
                                    ۱
                                </div>
                                <button type="button"
                                        class="c-quantity-selector__remove u-hidden c-quantity-selector__add--disabled js-minicart-remove">
                                ...
                                <button type="button" class="c-quantity-selector__trash js-mini-cart-remove-item "
                                        data-id="1440138433" data-product="6260732" data-variant="21059414"
                                        data-enhanced-ecommerce="null">
                                </button>
                            </div>
                        </div>
                ...
                <div class="c-cart-item__data">
                    ...
                    <div class="c-cart-item__title">
                        کتاب نمونه آزمونهای مستند و پرتکرار برگزار شده استخدامی مبانی جبر اثر فاطمه عزیزی نیک انتشارات&nbsp;رویای
                        سبز
                    </div>
            ...
            <div class="c-cart-item" data-price-change="" data-min-price-badge="">
                <div class="c-cart-item__thumb">
                    <a class="c-cart-item__thumb-img" href="" target="_blank">
                        <img alt="کتاب نمونه سوالات آزمونهای استخدامی"
                             src="https://dkstatics-public.digikala.com/digikala-products/89316.jpg?x-oss-process=image/resize,m_lfit,h_150,w_150/quality,q_80">
                    </a>
                    <div class="c-cart-item__price-row">
                        <div class="c-cart-item__quantity-row">
                            <div class="c-quantity-selector">
                                ...
                                <div class="c-quantity-selector__number js-minicart-count" data-id="21499255">
                                    ۱
                                </div>
                                <button type="button"
                                        class="c-quantity-selector__remove u-hidden c-quantity-selector__add--disabled js-minicart-remove">
                                ...
                                <button type="button" class="c-quantity-selector__trash js-mini-cart-remove-item "
                                        data-id="1440140775" data-product="38993" data-variant="21499255"
                                        data-enhanced-ecommerce="null">
                                </button>
                            </div>
                        </div>
            ...
            <div class="c-cart-item" data-price-change="" data-min-price-badge="">
                <div class="c-cart-item__thumb">
                    <a class="c-cart-item__thumb-img" href="" target="_blank">
                        <img alt="کتاب استخدامی دبیر ریاضی اثر دکتر سامیار نجومی نشر آراه "
                             src="https://dkstatics-public.digikala.com/digikala-products/629c5368c2e64a9ff2bfb937612f9bade81e589c_1612365136.jpg?x-oss-process=image/resize,m_lfit,h_150,w_150/quality,q_80">
                    </a>
                    <div class="c-cart-item__price-row">
                        <div class="c-cart-item__quantity-row">
                            <div class="c-quantity-selector">
                                ...
                                <div class="c-quantity-selector__number js-minicart-count" data-id="14088377">
                                    ۱
                                </div>
                                <button type="button"
                                        class="c-quantity-selector__remove u-hidden c-quantity-selector__add--disabled js-minicart-remove">
                                ...
                                <button type="button" class="c-quantity-selector__trash js-mini-cart-remove-item "
                                        data-id="1440127933" data-product="4387487" data-variant="14088377"
                                        data-enhanced-ecommerce="null">
                                </button>
                            </div>
                        </div>
                ...
                <div class="c-cart-item__data">
                    ...
                    <div class="c-cart-item__title">
                        کتاب استخدامی دبیر ریاضی اثر دکتر سامیار نجومی نشر آراه
                    </div>
        ...
        <div class="c-modal__footer">
            <div class="c-header__cart-info-total">
                ...
                <p class="c-header__cart-info-total-amount">
                    <span class="c-header__cart-info-total-amount-number"> ۲۴۰,۳۸۰</span>
                    <span> تومان</span>
                </p>
            </div>
...
<div class="remodal-wrapper remodal-is-closed" style="display: none;">
    <div class="remodal c-remodal-same-product remodal-is-initialized remodal-is-closed" data-remodal-id="sameProduct"
