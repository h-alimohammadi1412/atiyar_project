        ...
        <div class="container py-5 mb-lg-3">
            <div class="row justify-content-center pt-lg-4 text-center">
              <div class="col-lg-5 col-md-7 col-sm-9">
                ...
                <h2 class="h3 mb-4">به نظر نمی رسد صفحه مورد نظر شما را پیدا کنیم</h2>
                <p class="fs-md mb-4">
                  <u>در اینجا چند لینک مفید وجود دارد:</u>
                </p>
              </div>
            </div>
                  ...
                  <div class="col-sm-4 mb-3"><a class="card h-100 border-0 shadow-sm" href="/">
                      <div class="card-body">
                        <div class="d-flex align-items-center"><i class="ci-home text-primary h4 mb-0"></i>
                          <div class="ps-3">
                             <h5 class="fs-sm mb-0">صفحه نخست</h5><span class="text-muted fs-ms">بازگشت به صفحه اصلی</span>
                          </div>
                        </div>
                      </div></a></div>
                  <div class="col-sm-4 mb-3"><a class="card h-100 border-0 shadow-sm" href="#">
                      <div class="card-body">
                        <div class="d-flex align-items-center"><i class="ci-search text-success h4 mb-0"></i>
                          <div class="ps-3">
                           <h5 class="fs-sm mb-0">جستجو</h5><span class="text-muted fs-ms">با جستجوی پیشرفته پیدا کنید</span>
                          </div>
                        </div>
                      </div></a></div>
                  <div class="col-sm-4 mb-3"><a class="card h-100 border-0 shadow-sm" href="help-topics.html">
                      <div class="card-body">
                        <div class="d-flex align-items-center"><i class="ci-help text-info h4 mb-0"></i>
                          <div class="ps-3">
                            <h5 class="fs-sm mb-0">راهنما و پشتیبانی</h5><span class="text-muted fs-ms">به مرکز راهنمایی ما مراجعه کنید</span>
                          </div>
                        </div>
                      </div></a></div>
                </div>
