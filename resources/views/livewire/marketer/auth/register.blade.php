    ...
    <div class="c-new-login">
            ...
            <div class="c-new-login__sidebar-content">
                <header class="c-new-login__sidebar-header">
                    {{-- <a href="/registration/" class="c-new-login__logo">
                        <img src="https://marketer.digikala.com/static/files/9eb66c4d.svg"
                             alt="Digikala marketplace marketer center logo">
                    </a> --}}

                    <h1 class="c-new-login__header">ثبت‌نام در مرکز بازاریابان</h1>
                </header>
                ...
                <ul class="c-reg-steps">
                    ...
                    <li class="c-reg-steps__item c-reg-steps__item--next">
                        ...
                        <p class="c-reg-steps__description">به جمع بازاریابان آتی یار خوش آمدید.</p>
                    </li>
                </ul>
        ...
        <main class="c-new-login__main">
            <div class="c-reg-form">
                <form wire:submit.prevent="registerMarketerForm" >
                    ...
                    <div class="c-reg-form__row c-reg-form__row--gap-60">
                        <div class="c-reg-form__col c-reg-form__col--12 has-error">
                            ...
                            <div class="c-ui-input has-error">
                                ...
                                <input type="text" name="register[email]" wire:model.lazy="marketer.email"
                    ...
                    <div class="c-reg-form__row">
                        <div class="c-reg-form__col c-reg-form__col--12 has-error">
                            ...
                            <div class="c-ui-input has-error">
                                ...
                                <input type="password" name="register[password]" wire:model.lazy="marketer.password"
...
{{--                            </div>--}}
                    ...
                    <div class="c-reg-form__row">
                        <div class="c-reg-form__col c-reg-form__col--12">
                            ...
                            <div class="c-ui-input">
                                ...
                                <input type="text" name="register[register_phone]" wire:model.lazy="marketer.phone"
                    ...
                    <div class="c-reg-form__row c-reg-form__row--align-center c-reg-form__row--gap-40">
                        <div class="c-reg-form__col">
                            <p class="c-reg-form__text">قبلاً ثبت نام کرده‌ام. <a href="/marketer/account/login"
            ...
            <ul class="c-new-login__content-footer">
                ...
                <li class="c-new-login__content-footer-item">
                    <a target="_blank" href="https://marketeracademy.digikala.com/">مرکز آموزش بازاریابان</a>
                </li>
                <li class="c-new-login__content-footer-item">
                    <a target="_blank"
                       href="https://marketeracademy.digikala.com/%D8%B3%D9%88%D8%A7%D9%84%D8%A7%D8%AA-%D9%85%D8%AA%D8%AF%D8%A7%D9%88%D9%84/">سوالات
                        متداول</a>
                </li>
                <li class="c-new-login__content-footer-item">
