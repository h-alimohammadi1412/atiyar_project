                    ...
                    <div class="c-grid__row c-RD-profile__aife">
                        <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                                ...
                                @elseif($marketer->learning_status == null)
                                    <div
                                ...
                                @elseif($marketer->learning_status == 0)
                                    <div
                        ...
                        @if( $marketer->learning_status == null)
                            <div class="c-grid__col c-grid__col--sm-6 c-grid__col--lg-6">
                                <div wire:click="addToLearning({{$marketer->id}})"
                        ...
                        <div class="c-grid__col c-grid__col--sm-4 c-grid__col--lg-4">
                            <div class="c-form">
                                ...
                                <div class="c-ui-input ">
                                    ...
                                    <input type="text" name="" placeholder="{{$marketer->code_marketer}}"
                                           class="c-ui-input__field c-ui-input__RD-field"
                                          value="{{$marketer->code_marketer}}" readonly=""
                                          >
                            ...
                            <div class="c-form">
                                ...
                                <div class="c-ui-input ">
                                    ...
                                    <input type="text" name=""
                                           class="c-ui-input__field c-ui-input__RD-field"
                                           id="seller-type" value="{{$marketer->type_marketer}}" readonly=""
                                           tabindex="-1">
                                ...
                                <div data-show="{sellerType:private}">
                                    ...
                                    <div class="c-ui-input ">
                                        ...
                                        <input type="text"
                                               ...
                                               class="c-ui-input__field c-ui-input__RD-field"
                                               id="seller-first-name" value="{{$marketer->name}}"
                                               data-no-access="{registerStatus : approved}"
                                               readonly="" tabindex="-1">
                                ...
                                <div data-show="{sellerType:private}">
                                    ...
                                    <div class="c-ui-input ">
                                        ...
                                        <input type="text" name="businessInfo[lastName]"
                                               class="c-ui-input__field c-ui-input__RD-field"
                                               id="seller-last-name" value="{{$marketer->lname}}"
                                               data-no-access="{registerStatus : approved}"
                                               readonly="" tabindex="-1">
                                ...
                                <div data-show="{sellerType:business}"
                                    ...
                                    <div class="c-ui-input ">
                                        ...
                                        <input type="text"
                                               ...
                                               class="c-ui-input__field c-ui-input__RD-field"
                                               id="seller-company-name" value="{{$marketer->company_name}}"
                                               data-no-access="{registerStatus : approved}"
                                               readonly="" tabindex="-1">
                            ...
                            <div class="c-form">
                                ...
                                <div class="c-ui-input ">
                                    ...
                                    <input type="text" name="businessInfo[birthDate]"
                                           ...
                                           value="{{\Morilog\Jalali\CalendarUtils::strftime('Y-m-d',strtotime($marketer->birth))}}"
                                           data-no-access="{registerStatus : approved}"
                                           readonly="" tabindex="-1">
                                ...
                                <div data-show="{sellerType:business}"
                                    ...
                                    <div class="c-ui-input ">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{$marketer->shenasname_code}}"
                                               data-no-access="{registerStatus : approved}"
                                               readonly="" tabindex="-1">
                                ...
                                <div data-show="{sellerType:private}">
                                    ...
                                    <div class="c-ui-input ">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{$marketer->shenasname_code}}" minlength="1"
                                               maxlength="10"
                                               data-no-access="{registerStatus : approved}"
                                               readonly="" tabindex="-1">
                    ...
                    <div class="c-grid__row uk-margin-medium-top">
                        ...
                        <div class="c-profile-seller-description-container">
                            ...
                            <textarea
                                      ...
                                      style="height: 80px; border-color: #dddddd; font-weight: bold;" wire:model.defer="aboutUs" placeholder="{{$marketer->about}}">{{$marketer->about}}</textarea>
                                </div>
                            ...
                            <div class="c-grid__row">
                                <div
                                    ...
                                    <div class="c-grid__row"
                                         ...
                                         data-index="0">
                                        @foreach(\App\Models\MarketerDoc::where('user_id',auth()->user()->id)->get() as $doc)
    ...
    <div>
        <div class="c-profile-business-info-about-seller-sample-modal__main-container">
            ...
            <div class="c-profile-business-info-about-seller-sample-modal__description">
                فروشگاه اینترنتی آتی یار، فعالیتش را از سال 1385 آغاز نموده است. این
                ...
                خاورمیانه محسوب می شود. امروز به غیر از فروشگاه آنلاین آتی یار
                شرکت‌های دیگری از قبیل دیجی‌استایل، فیدیبو، دیجی‌پی، آتی یار نکست و
