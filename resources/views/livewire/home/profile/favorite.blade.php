...
<section class="col-lg-8">
    ...
    <div class="d-sm-flex justify-content-between mt-lg-4 mb-4 pb-3 pb-sm-2 border-bottom">
        <div class="d-block d-sm-flex align-items-start text-center text-sm-start"><a
                ...
                href="{{ url('/product/at-' . $favorite->product->id . '/' . $favorite->product->link) }}"
                style="width: 10rem;"><img src="/storage/{{ $favorite->product->img }}" alt="محصول"></a>
            <div class="pt-2">
                <h3 class="product-title fs-base mb-2"><a
                        href="{{ url('/product/at-' . $favorite->product->id . '/' . $favorite->product->link) }}">{{
                        $favorite->product->title }}</a></h3>
                ...
                <div class="fs-lg text-accent pt-2">@if($favorite->product->price == 0 || $favorite->product->price ==
                    null) ناموجود @else {{ $favorite->product->price }} @endif</div>
            </div>
        </div>
