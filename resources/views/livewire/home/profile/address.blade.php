            ...
            <div class="container c-profile-page">
                <section class="o-page">
                    <div class="o-page__row">
                        ...
                        @include('livewire.home.profile.address.address')
                    </div>
                </section>
            </div>
        </div>
...
@section('profile_content')
    <!-- آدرس جدید-->
    <form class="needs-validation modal fade @if ($show) show @endif"
        @if ($show) style="display: block; background: rgba(0,0,0,.5);" @endif wire:submit.prevent='addressForm' id="add-address"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                    ...
                    <div class="row gx-4 gy-3">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input class="form-control" type="text" id="address-company1"
                                wire:model.lazy="address.address" required>
                            <div class="invalid-feedback">لطفا شهر خود را پر کنید</div>
                        </div>
                        <div class="col-sm-4">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary btn-shadow" type="submit">@if($edit) ویرایش کردن @else اضافه کردن @endif</button>
                </div>
            </div>
        </div>
    </form>
                        ...
                        <tr>
                            ...
                            <td class="py-3 align-middle">
                                <a class="nav-link-style me-2" data-bs-toggle="tooltip" title=""
                                    wire:click="editForm({{ $address }})" data-bs-original-title="ویرایش"
                                    aria-label="ویرایش"><i class="ci-edit"></i>
                                </a>
                                <a class="nav-link-style text-danger" data-bs-toggle="tooltip"
                                    wire:click="deleteAddress( {{ $address->id }})" title=""
