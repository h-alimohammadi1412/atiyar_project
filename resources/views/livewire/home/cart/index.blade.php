        ...
        <div class="row">
            ...
            <section class="col-lg-8">
                ...
                <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                    <div class="d-block d-sm-flex align-items-center text-center text-sm-start">
                        ...
                        <a class="d-inline-block flex-shrink-0 mx-auto me-sm-4"
                            ...
                            <img src="/storage/{{ $cart->productSeller->product->img }}" width="160" alt="محصول" />
                        </a>
                        <div class="pt-2">
                            ...
                            @if($cart->productSeller->product_count < 8 ) <div class="fs-sm mt-3 text-primary">
                                <span class="me-2">تنها {{$cart->productSeller->product_count }} عدد در انبار باقیست |
                                    پیش از اتمام بخرید </span>
                        </div>
                        @endif
                        @endif
                ...
                <div class="d-flex flex-wrap justify-content-center mx-auto mx-sm-0 ps-sm-3 pt-2 pt-sm-0 text-center text-sm-start"
                    ...
                    <button class="btn btn-link px-0 py-0 text-danger" wire:click="deleteCartProduct({{ $cart->id }})">
        ...
        <aside class="col-lg-4 pt-4 pt-lg-0 ps-xl-5">
            <div class="bg-white rounded-3 shadow-lg p-4">
                <div class="py-2 px-xl-2">
                    ...
                    <div class="align-items-center border-bottom d-flex justify-content-between mb-2 text-center">
                        <h2 class="h6 mb-3 pb-1 fs-md">جمع سبد خرید</h2>
                        <h3 class="fw-normal fs-md fw-bold">{{ number_format($total_price_cart) }}</h3>
                    </div>
                    <div class="align-items-center border-bottom d-flex justify-content-between mb-2 text-center">
