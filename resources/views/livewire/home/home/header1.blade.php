        ...
        <div class="container">
            ...
            <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                ...
                <div class="navbar-tool dropdown ms-3">
                    ...
                    {{-- @dd($carts) --}}
                    <a class="navbar-tool-text" href="{{ url('/cart') }}"><small>سبدخرید</small>{{ number_format($carts->totalPrice) }}</a>
                    <!-- Cart dropdown-->
                        ...
                        <div class="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem;">
                            <div style="height: 15rem;" data-simplebar data-simplebar-auto-hide="false">
                                ...
                                <div class="widget-cart-item pb-2 border-bottom">
                                    ...
                                    <div class="d-flex align-items-center"><a class="d-block flex-shrink-0"
                                            href="{{ url('/product/at-' . $cart->productSeller->product->id . '/' . $cart->productSeller->product->link) }}"><img src="/storage/{{ $cart->productSeller->product->img }}"
                                                width="64" alt="محصول"></a>
                                        <div class="ps-2">
                                            <h6 class="widget-product-title"><a href="shop-single-v2.html">{{ substr($cart->productSeller->product->title,0, 50) . '...' }}</a>
                                            </h6>
                                            <div class="widget-product-meta"><span
                                                    class="text-accent me-2 ms-1">{{ number_format($cart->productSeller->discount_price) }}</span><span
                            ...
                            <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                                <div class="fs-sm me-2 py-2"><span class="text-muted">جمع کل:</span>
                                    <span class="text-accent fs-base ms-1">{{ number_format($carts->totalPrice) }}</span>
                                    </div>
                                        {{-- <a class="btn btn-outline-secondary btn-sm" href="{{ route('cart.index') }}">ادامه خرید<i class="ci-arrow-right ms-1 me-n1"></i></a> --}}
                            </div>
