    ...
    <div class="row pt-2 pb-3">
        <div class="col-lg-4 col-md-5">
            ...
            <div class="star-rating me-2"><i class="ci-star-filled fs-sm text-accent me-1"></i><i
                    ...
                    class="ci-star-filled fs-sm text-accent me-1"></i><i
                    class="ci-star-filled fs-sm text-accent me-1"></i><i class="ci-star fs-sm text-muted me-1"></i>
            </div><span class="d-inline-block align-middle">74 نظر</span>
        ...
        <div class="col-md-7">
            <div class="d-flex justify-content-end pb-4">
                <div class="d-flex flex-nowrap align-items-center">
                    <label class="fs-sm text-muted text-nowrap me-2 d-none d-sm-block" for="sort-reviews">مرتب
                        سازی:</label>
            ...
            <div class="product-review pb-4 mb-4 border-bottom">
                <div class="d-flex mb-3">
                    <div class="d-flex align-items-center me-4 pe-2"><img class="rounded-circle"
                        ...
                        <div class="ps-3">
                            <h6 class="fs-sm mb-0">جاناتان دوو</h6><span class="fs-ms text-muted">26 تیر 1400</span>
                        </div>
                    </div>
                    <div>
                        <div class="star-rating"><i class="star-rating-icon ci-star-filled active"></i><i
            ...
            <div class="product-review pb-4 mb-4 border-bottom">
                <div class="d-flex mb-3">
                    <div class="d-flex align-items-center me-4 pe-2"><img class="rounded-circle"
                        ...
                        <div class="ps-3">
                            <h6 class="fs-sm mb-0">لورا ویلسون</h6><span class="fs-ms text-muted">26 تیر 1400</span>
                        </div>
                    </div>
                    <div>
                        <div class="star-rating"><i class="star-rating-icon ci-star-filled active"></i><i
            ...
            <div class="text-center">
                <button class="btn btn-outline-accent" type="button"><i class="ci-reload me-2"></i>بیشتر
                    دیدن</button>
            </div>
        </div>
        <!-- Leave review form-->
            ...
            <div class="bg-secondary py-grid-gutter px-grid-gutter rounded-3">
                ...
                <form class="needs-validation" method="post" novalidate>
                    <div class="mb-3">
                        ...
                        <div class="invalid-feedback">نام را وارد کنید</div><small class="form-text text-muted">در نظر
                    ...
                    <div class="mb-3">
                        ...
                        <div class="invalid-feedback"> یک نظر بنویسید!</div><small class="form-text text-muted">نظر
                            شما باید حداقل 50 نویسه باشد.</small>
                    </div>
                    <div class="mb-3">
