<div class="sidebar__nav border-top border-left  ">
    ...
    <a href="/">
        <img style="height: 30px;margin-top: 15px;margin-right: 50px" src="{{ asset('img/weblogo.png') }}"
            alt=""></a>
    ...
    <ul>
        ...
        @can('show-category')
            <li class="item-li i-categories {{ Request::routeIs('category.index') ? 'is-active' : '' }}"><a
                    href="/admin/category">دسته بندی ها</a></li>
        @endcan
        @can('show-product')
            <li class="item-li i-banners {{ Request::routeIs('product.index') ? 'is-active' : '' }}"><a
                    href="/admin/product">محصولات</a></li>
        @endcan
        @can('show-brand')
            <li class="item-li i-my__purchases {{ Request::routeIs('brand.index') ? 'is-active' : '' }}"><a
                    href="/admin/brand">برند محصولات</a></li>
        @endcan
        ...
        <li class="item-li i-users {{ Request::routeIs('users.index') ? 'is-active' : '' }}"><a
                href="/admin/users">کاربران</a>
        </li>
        <li class="item-li i-user__inforamtion {{ Request::routeIs('seller.index') ? 'is-active' : '' }}"><a
                ...
                <li class="item-li i-user__inforamtion {{ Request::routeIs('marketer.index') ? 'is-active' : '' }}"><a
                        href="/admin/marketer">بازاریاب ها</a></li>
        <li class="item-li i-slideshow {{ Request::routeIs('role.index') ? 'is-active' : '' }}"><a
                href="/admin/role">مقام
                ها</a></li>
        ...
        <li class="item-li i-comments {{ Request::routeIs('social.index') ? 'is-active' : '' }}"><a
                href="/admin/social">شبکه
                های اجتماعی</a></li>
        <li class="item-li i-ads {{ Request::routeIs('ads.index') ? 'is-active' : '' }}"><a
                href="/admin/ads">تبلیغات</a>
        </li>
        <li class="item-li i-articles {{ Request::routeIs('banner.index') ? 'is-active' : '' }}"><a
                href="/admin/banner">بنرها</a>
        </li>
        <li class="item-li i-slideshow {{ Request::routeIs('slider.index') ? 'is-active' : '' }}"><a
                href="/admin/slider">اسلایدر</a>
        </li>
        <hr style="margin-left: 15px;margin-right: 25px">
        <span style="font-size: small;color: burlywood;">
            کدهای تخفیف
        ...
        <li class="item-li i-slideshow {{ Request::routeIs('admin.gift.index') ? 'is-active' : '' }}"><a
                href="/admin/gift">کارت
                های هدیه</a></li>
        <hr style="margin-left: 15px;margin-right: 25px">
        <span style="font-size: small;color: burlywood;">
            سفارشات و پرداخت ها
        ...
        <li class="item-li i-slideshow {{ Request::routeIs('page.index') ? 'is-active' : '' }}"><a
                href="/admin/page">صفحات
                سایت</a></li>
        ...
        <li class="item-li i-slideshow {{ Request::routeIs('footer.index') ? 'is-active' : '' }}"><a
                href="/admin/footer">تنظیمات
                فوتر سایت</a></li>
        <li class="item-li i-courses {{ Request::routeIs('header.index') ? 'is-active' : '' }}"><a
                href="/admin/header">
                تنظیمات سایت</a></li>
        <li class="item-li i-my__peyments {{ Request::routeIs('email.index') ? 'is-active' : '' }}"><a
                href="/admin/email"> ایمیل ها</a></li>
        <li class="item-li i-articles {{ Request::routeIs('log.index') ? 'is-active' : '' }}"><a
                href="/admin/log">گزارشات
                سیستم</a></li>
