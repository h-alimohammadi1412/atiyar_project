    ...
    <div class="main-content" wire:init="loadCategory">
        <div class="tab__box">
            <div class="tab__items">
                <a class="tab__item is-active" href="/admin/menu">پیشنهاد شگفت انگیز </a>
                ...
                <a class="t-header-search">
                    <form action="" onclick="event.preventDefault();">
                        <input wire:model.debounce.1000="search" type="text" class="text"
                            placeholder="جستجوی پیشنهاد شگفت انگیز ...">
                    </form>
                </a>
                                    ...
                                    <tr role="row">
                                        ...
                                        <td>
                                            @if ($specialProduct->status == 1)
                                                <button
                                                    wire:click="updateStatus('SpecialProduct','special/product','پیشنهاد شگفت انگیز','status',{{ $specialProduct->id }})"
                                        ...
                                        <td>
                                            <a wire:click="deletedFieldAsModel('SpecialProduct','special/product','پیشنهاد شگفت انگیز','{{ $specialProduct->product->title }}','{{ $specialProduct->id }}')"
            ...
            <div class="col-4 bg-white">
                ...
                <form wire:submit.prevent="categoryForm" enctype="multipart/form-data" role="form"
                    ...
                    <div class="form-group">
                        <select wire:model.lazy="category_id" name="category_id" id=""
                            class="form-control">
                    ...
                    <div class="form-group">
                        <select wire:model.lazy="specialProduct.product_id" name="product_id" id=""
                            ...
                            @foreach (\App\Models\SpecialProduct::with('product')->where('category_id',  $category_id)->get() as $product)
                    ...
                    <div class="form-group">
                        <div class="notificationGroup">
                            <input id="option7" type="checkbox" wire:model.lazy="specialProduct.natural"
                                name="natural" class="form-control">
                    ...
                    <div class="form-group">
                        <div class="notificationGroup">
                            <input id="option8" type="checkbox" wire:model.lazy="specialProduct.supermarket"
                                name="supermarket" class="form-control">
