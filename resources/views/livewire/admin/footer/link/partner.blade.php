@section('title','صفحات فوتر پارتنر سایت')
<div>
    <div class="main-content" wire:init="loadCategory">
        <div class="tab__box">
            <div class="tab__items">
                ...
                <a class="tab__item is-active " href="/admin/footer/partner">صفحات پایین فوتر سایت</a>
                        ...
                        @if($readyToLoad)
                            ...
                            @foreach($footer_links as $footer_page)
                                <tr role="row">
                                    ...
                                    <td>
                                        <a wire:click="deletedFieldAsModel('FooterPartner','footer','صفحه بالای فوتر سایت','{{ $footer_page->getPage->title }}','{{ $footer_page->id }}')" type="submit"
