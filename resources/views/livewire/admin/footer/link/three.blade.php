@section('title','صفحات فوتر سه سایت')
<div>
    <div class="main-content" wire:init="loadCategory">
        <div class="tab__box">
            <div class="tab__items">
                ...
                <a class="tab__item is-active" href="/admin/footer/link3">فوتر لینک سه</a>
            ...
            <div class="col-4 bg-white">
                ...
                <form wire:submit.prevent="categoryForm"
                    ...
                    <div class="form-group">
                        <select wire:model.lazy="footerLinkThree.page_id" name="page_id" id="" class="form-control">
