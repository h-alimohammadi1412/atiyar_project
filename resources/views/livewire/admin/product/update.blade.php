                ...
                <form wire:submit.prevent="categoryForm"
                    ...
                    <div class="row p-0 m-0">
                        <div class="col-xs-12 col-md-6 p-0 order-1 order-md-0 ">
                                ...
                                <div class="form-group">
                                    <select wire:model.lazy="product.status_product" name="status_product" id=""
                                        ...
                                        @foreach (\App\Models\Product::productStatus() as $key => $value)
                                            <option value="{{ $key }}" @if($product->status_product == $key) selected  @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <button class="btn btn-brand my-5 w-100">آپدیت محصول</button>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-6 p-0 ps-md-4 order-0 order-md-1">
                            ...
                            <div>
                                ...
                                @endif
                                @if (!$img)
                                    <img class="form-control mt-3 mb-3" width="400" src="/storage/{{ $product->img }}"
                                        alt="">
                                @endif
                            </div>
                        </div>
