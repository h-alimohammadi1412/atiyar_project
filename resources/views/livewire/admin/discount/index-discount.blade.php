                            ...
                            <tr role="row">
                                ...
                                <td>
                                    <a style="cursor: pointer;"
                                        wire:click="updateStatus('Discount','discount','کد تخفیف','status',{{ $discount->id }})"><span
                                            class="alert @if ($discount->status == 1)  alert-success @else alert-danger   @endif">
                                            @if($discount->status == 1) فعال @else غیرفعال @endif</span>
                                    </a>
            ...
            <div class="col-4 bg-white">
                ...
                <form wire:submit.prevent="categoryForm" enctype="multipart/form-data" role="form"
                    ...
                    <div class="form-group">
                        <input type="text" wire:model.lazy="discount.code"
                            placeholder="کد تخفیف(می تواند خالی باشد)" class="form-control">
                    </div>
                    <div class="form-group">
                        <input type="text" wire:model.lazy="discount.price"
                            placeholder="مبلغ کارت تخفیف(می تواند خالی باشد)  " class="form-control">
                    </div>
                    <div class="form-group">
                        <input type="text" wire:model.lazy="discount.percent"
                            placeholder="درصد تخفیف(می تواند خالی باشد)  " class="form-control">
                    </div>
                    <div class="form-group">
